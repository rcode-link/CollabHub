        ...
        <fwb-dropdown text="Bottom">
            <template #trigger>
                <h1 class="flex gap-1 cursor-pointer items-center">
                    <KanbanIcon
                        class="w-6 h-6"
                        v-if="boardsState.activeBoard.type === 'kanban'"
                    />
                    <ScrumIcon
                        class="w-6 h-6"
                        v-if="boardsState.activeBoard.type === 'scrum'"
                    />
            ...
            <fwb-list-group>
                <fwb-list-group-item
                    v-for="obj in boardsState.getBoards"
                    :key="obj"
                ...
                <fwb-list-group-item
                    ...
                    @click="() => boardModalRef.toggleModal()"
                >
...
const shouldSprintSelectionBeVisible = computed(
    () => boardsState.getActiveBoard.type === "scrum"
);
