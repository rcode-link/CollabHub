        ...
        children: [
            {
                ...
                path: "base",
                component: () =>
                    import("../components/pages/settings/me/Index.vue"),
            },
            {
            ...
            },
            {
                ...
                path: "users",
                component: () =>
                    import("../components/pages/settings/users/Users.vue"),
            },
            {
                name: "settings.roles",
                path: "roles/:id",
        ...
        children: [
            {
                ...
                path: ":chatId/view",
                component: () =>
                    import("../components/pages/chat/ChatDetails.vue"),
            },
        ],
    },
    {
        ...
        children: [
            {
                ...
                path: "dashboard",
                component: () =>
                    import("../components/pages/project/Dashboard.vue"),
            },
            {
                name: "project.tasks",
                path: "backlog",
                component: () =>
                    import("../components/pages/project/tasks/List.vue"),
            },
            {
                name: "project.boards",
                path: "boards/:board?",
                component: () =>
                    import("../components/pages/project/board/Index.vue"),
                children: [
                    {
                        ...
                        component: () =>
                            import(
                                "../components/pages/project/board/view/Board.vue"
                            ),
                    },
                    {
                        ...
                        component: () =>
                            import(
                                "../components/pages/project/board/tasks/Index.vue"
                            ),
                    },
                    {
                        ...
                        component: () =>
                            import(
                                "../components/pages/project/board/settings/Index.vue"
                            ),
                    },
                ],
            },
                ...
                children: [
                    {
                        ...
                        component: () =>
                            import(
                                "../components/pages/project/settings/Users.vue"
                            ),
                    },
                    {
                        ...
                        component: () =>
                            import(
                                "../components/pages/project/settings/Security.vue"
                            ),
                    },
                ],
            },
