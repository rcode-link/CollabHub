...
import { groupBy as loGroupBy, remove, sumBy } from "lodash";
...
<template>
    ...
    <fwb-accordion-content>
        ...
        <template v-if="groupBy === 'yyyy LLL dd'" :key="model.length">
            ...
            <div
                class="grid grid-cols-4 pl-4 border-b hover:bg-gray-100 hover:dark:bg-gray-700"
                v-for="obj in data[selectedDay]"
            >
                <div>
                    {{
                        DateTime.fromISO(obj.start).toLocaleString(
                ...
                <div>
                    {{
                        DateTime.fromISO(obj.end).toLocaleString(
                            DateTime.DATETIME_MED
                        )
                    }}
                </div>
                ...
                <div class="flex justify-end">
                    <InteractiveToast>
                        ...
                        <template #actions>
                            <fwb-button @click="() => removeDate(obj)" size="xs"
