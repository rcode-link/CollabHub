      ...
      <Card class="max-w-lg m-auto">
        <form @submit.prevent="register" class="w-full grid gap-6">
          ...
          <div>
            ...
            <Text type="text" v-model="form.email" id="email" :name="'email'" form="'login'" placeholder="Email"/>
            <Errors name="email"/>
          </div>
          <div>
            <Label :forInput="'fullName'">Full Name</Label>
            <Text type="text" v-model="form.name" id="fullName" :name="'name'" form="'login'" placeholder="Full Name"/>
            <Errors name="name"/>
          </div>
          <div>
          ...
          <div>
            ...
            <Text type="password" v-model="form.password_confirmation" id="password_confirmation"
                  :name="'password_confirmation'" form="'login'"
