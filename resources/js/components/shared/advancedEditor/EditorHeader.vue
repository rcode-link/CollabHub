...
<template>
  <fwb-button
    :color="editor.isActive('bold') ? 'dark' : 'alternative'"
  ...
  <fwb-button
    :color="editor.isActive('italic') ? 'dark' : 'alternative'"
    @click="
      (e) => buttonClicked(e, editor.chain().focus().toggleItalic().run())
    "
  ...
  <fwb-button
    ...
    @click="
      (e) => buttonClicked(e, editor.chain().focus().toggleStrike().run())
    "
  ...
  <fwb-dropdown text="Bottom">
    ...
    <fwb-list-group>
      <fwb-list-group-item
        ...
        @click="
          (e) => buttonClicked(e, editor.chain().focus().setParagraph().run())
        "
      >
        paragraph
      </fwb-list-group-item>
      <fwb-list-group-item
        class="hover:bg-gray-100 cursor-pointer text-5xl"
        @click="
          (e) =>
            buttonClicked(
              e,
      ...
      <fwb-list-group-item
        class="hover:bg-gray-100 cursor-pointer text-4xl"
        @click="
          (e) =>
            buttonClicked(
              e,
      ...
      <fwb-list-group-item
        class="hover:bg-gray-100 cursor-pointer text-3xl"
        @click="
          (e) =>
            buttonClicked(
              e,
      ...
      <fwb-list-group-item
        class="hover:bg-gray-100 cursor-pointer text-2xl"
        @click="
          (e) =>
            buttonClicked(
              e,
      ...
      <fwb-list-group-item
        class="hover:bg-gray-100 cursor-pointer text-xl"
        @click="
          (e) =>
            buttonClicked(
              e,
  ...
  <fwb-dropdown>
    ...
    <fwb-list-group>
      <fwb-list-group-item
        ...
        @click="
          (e) =>
            buttonClicked(e, editor.chain().focus().toggleBlockquote().run())
        "
      >
      ...
      <fwb-list-group-item
        ...
        @click="
          (e) =>
            buttonClicked(e, editor.chain().focus().toggleCodeBlock().run())
        "
      >
      ...
      <fwb-list-group-item
        ...
        @click="
          (e) =>
            buttonClicked(e, editor.chain().focus().toggleBulletList().run())
        "
      >
      ...
      <fwb-list-group-item
        ...
        @click="
          (e) =>
            buttonClicked(e, editor.chain().focus().toggleOrderedList().run())
        "
      >
